        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-8 tracking-tight">
              나도람 축제 <span className="text-primary">소개</span>
            </h2>
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="p-8 bg-muted/20 rounded-2xl border border-white/5">
                <h4 className="text-primary font-bold text-lg mb-2">나눔</h4>
                <p className="text-sm text-muted-foreground">마음을 나누고 기쁨을 더하는 시간</p>
              </div>
              <div className="p-8 bg-muted/20 rounded-2xl border border-white/5">
                <h4 className="text-primary font-bold text-lg mb-2">도전</h4>
                <p className="text-sm text-muted-foreground">새로운 가능성을 향한 힘찬 발걸음</p>
              </div>
              <div className="p-8 bg-muted/20 rounded-2xl border border-white/5">
                <h4 className="text-primary font-bold text-lg mb-2">함께</h4>
